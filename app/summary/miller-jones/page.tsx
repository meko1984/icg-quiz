...
const grades = [
  ...
  ['P3', 80, '膿性部分が2/3以上', '膿性部分が多い痰です。一般細菌の培養に適した性状として評価されます。'],
] as const;
...
export default function MillerJones() {
  return <StudyPage title="Miller & Jones分類"><div className={s.page}>
    ...
    <section className={s.sources}><h2>出典・確認日</h2><p>2026年9月9日確認。</p><ol>
