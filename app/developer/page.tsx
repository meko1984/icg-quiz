  ...
  return (
    <main className="app-shell">
      <article className="home-card chapter-card developer-card">
        ...
        <section className="study-section"><h2>このバージョンでできること</h2><ul className="feature-list"><li>12のテーマから選べる「サクッとまとめ」</li><li>第1回・第2回の4択クイズ、全{questions.length}問</li><li>間違えた問題の復習と成績履歴</li></ul></section>
